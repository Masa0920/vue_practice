...
export default {
  ...
  created(){
    axios.get(`https://itunes.apple.com/search?term=${this.$route.params.keyword}&entity=musicTrack&attribute=genreIndex&lang=ja_jp`) // see https://www.youtube.com/watch?v=8Dv23fu8G_g
      .then((response) => {
